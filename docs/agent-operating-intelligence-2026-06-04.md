...
by purpose. Verified live 2026-06-04 on the 9-month margin account (…0497): equity ≈ **$[redacted]**, market
value ≈ **$[redacted]**, `cash` ≈ **$[redacted]** (margin debit), but actual `buying_power` ≈ **$[redacted]**.
